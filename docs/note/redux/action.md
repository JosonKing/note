...
Reducer 在异步操作结束后自动执行，这就要用到新的工具：中间件（middleware）。
![异步](http://www.ruanyifeng.com/blogimg/asset/2016/bg2016092002.jpg)
## 一、中间件的概念
...
## 五、redux-thunk 中间件
异步操作至少要送出两个 Action：用户触发第一个 Action，这个跟同步操作一样；通过 Action Creator 在操作结束时，系统自动送出第二个 Action。
```
...
![fetchPosts](http://www.ruanyifeng.com/blogimg/asset/2016/bg2016092003.jpg)
```
